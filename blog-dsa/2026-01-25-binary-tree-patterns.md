---
slug: binary-tree-patterns-guide
title: Master Binary Trees - Complete Pattern Guide for Interviews
authors: []
tags: [dsa, binary-trees, leetcode, interview-prep]
---
...
5. [Sum Root to Leaf Numbers](https://leetcode.com/problems/sum-root-to-leaf-numbers/)
6. [Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths/)
7. [Smallest String Starting From Leaf](https://leetcode.com/problems/smallest-string-starting-from-leaf/)
8. [Longest Univalue Path](https://leetcode.com/problems/longest-univalue-path/)
...
6. [Insert into a Binary Search Tree](https://leetcode.com/problems/insert-into-a-binary-search-tree/)
7. [Recover Binary Search Tree](https://leetcode.com/problems/recover-binary-search-tree/)
8. [Unique Binary Search Trees](https://leetcode.com/problems/unique-binary-search-trees/)
9. [Unique Binary Search Trees II](https://leetcode.com/problems/unique-binary-search-trees-ii/)
...
4. [Lowest Common Ancestor of a Binary Tree II](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree-ii/)
5. [Lowest Common Ancestor of a Binary Tree III](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree-iii/)
6. [Lowest Common Ancestor of a Binary Tree IV](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree-iv/)
...
2. [Boundary of Binary Tree](https://leetcode.com/problems/boundary-of-binary-tree/)
3. [Vertical Order Traversal of a Binary Tree](https://leetcode.com/problems/vertical-order-traversal-of-a-binary-tree/)
4. [Binary Tree Top View](https://leetcode.com/problems/binary-tree-top-view/) *(Premium)*
5. [Binary Tree Bottom View](https://leetcode.com/problems/binary-tree-bottom-view/) *(Premium)*
...
3. [Encode N-ary Tree to Binary Tree](https://leetcode.com/problems/encode-n-ary-tree-to-binary-tree/)
4. [Verify Preorder Serialization of a Binary Tree](https://leetcode.com/problems/verify-preorder-serialization-of-a-binary-tree/)
...
3. [Distribute Coins in Binary Tree](https://leetcode.com/problems/distribute-coins-in-binary-tree/)
4. [Maximum Sum BST in Binary Tree](https://leetcode.com/problems/maximum-sum-bst-in-binary-tree/)
5. [Binary Tree Maximum Product of Splitted Tree](https://leetcode.com/problems/maximum-product-of-splitted-tree/)
6. [All Possible Full Binary Trees](https://leetcode.com/problems/all-possible-full-binary-trees/)
...
2. [N-ary Tree Level Order Traversal](https://leetcode.com/problems/n-ary-tree-level-order-traversal/)
3. [N-ary Tree Preorder Traversal](https://leetcode.com/problems/n-ary-tree-preorder-traversal/)
4. [N-ary Tree Postorder Traversal](https://leetcode.com/problems/n-ary-tree-postorder-traversal/)
...
8. [Replace Words](https://leetcode.com/problems/replace-words/)
...
2. [Find Distance in Binary Tree](https://leetcode.com/problems/find-distance-in-binary-tree/) *(Premium)*
...
4. [Closest Leaf in a Binary Tree](https://leetcode.com/problems/closest-leaf-in-a-binary-tree/) *(Premium)*
...
8. [Binary Tree Cameras](https://leetcode.com/problems/binary-tree-cameras/)
9. [Word Search II](https://leetcode.com/problems/word-search-ii/)
10. [Recover Binary Search Tree](https://leetcode.com/problems/recover-binary-search-tree/)
